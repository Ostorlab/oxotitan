...
export default defineComponent ({
  ...
  computed: {
    ...mapState(useScannersStore, {
      scanner: (state) => state.scanners[0]
    }),
  ...
  methods: {
    ...
    async stopScan() {
      ...
      try {
        await this.scanService.stopScan(this.scanner, parseInt(this.scanId))
...
/* This CSS selector applies when the input has focus */
